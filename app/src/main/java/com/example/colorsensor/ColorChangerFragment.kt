...
class ColorChangerFragment : Fragment(), ColorPickerDialogFragment.OnColorSelectedListener {
    ...
    companion object {
        fun newInstance(imageUri: String): ColorChangerFragment {
            val fragment = ColorChangerFragment()
            val args = Bundle()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rgbValueText = requireView().findViewById(R.id.rgbValueText)
        imageView = requireView().findViewById(R.id.imageView)
        colorsButton = requireView().findViewById(R.id.colorsButton)
        undoButton = requireView().findViewById(R.id.undoButton)
        resetButton = requireView().findViewById(R.id.resetButton)
        colorBox = requireView().findViewById(R.id.colorBox)
        ...
        arguments?.let {
            imageUriString = it.getString("image_uri")
        }
