...
class ImageSplitFragment : Fragment(), ColorPickerDialogFragment.OnColorSelectedListener {
    ...
    companion object {
        ...
        fun newInstance(imageUri: String): ImageSplitFragment {
            val fragment = ImageSplitFragment()
            val args = Bundle()
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_image_split, container, false)
    }
